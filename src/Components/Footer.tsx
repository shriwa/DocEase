...
const Footer:React.FC = () => {
  return (
    <footer className="p-4 bg-gray-50 sm:p-6 font-semibold  text-text_1 dark:bg-gray-800  bg-primary">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com" className="flex items-center">
                    <img src={logo_1} className="mr-3 h-24 rounded-md" alt="FlowBite Logo" />
                    <span className="self-center  text-2xl font-semibold whitespace-nowrap text-white">DocEase</span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase text-white">Our Services</h2>
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="#" className="hover:underline">E-Description</a>
                        </li>
                        <li>
                            <a href="#" className="hover:underline">Patient History</a>
                        </li>
                    </ul>
                </div>
                <div>
